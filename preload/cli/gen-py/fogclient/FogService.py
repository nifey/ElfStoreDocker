...
class Iface(object):
    ...
    def writeErasureCoded(self, mbMetadata, data):
        """
        Parameters:
         - mbMetadata
         - data
...
class Client(Iface):
    ...
    def writeErasureCoded(self, mbMetadata, data):
        ...
        Parameters:
         ...
         - data
        """
        self.send_writeErasureCoded(mbMetadata, data)
        return self.recv_writeErasureCoded()

    def send_writeErasureCoded(self, mbMetadata, data):
        self._oprot.writeMessageBegin('writeErasureCoded', TMessageType.CALL, self._seqid)
        args = writeErasureCoded_args()
        args.mbMetadata = mbMetadata
        args.data = data
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_writeErasureCoded(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = writeErasureCoded_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "writeErasureCoded failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["writeErasureCoded"] = Processor.process_writeErasureCoded
    ...
    def process_writeErasureCoded(self, seqid, iprot, oprot):
        args = writeErasureCoded_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = writeErasureCoded_result()
        try:
            result.success = self._handler.writeErasureCoded(args.mbMetadata, args.data)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("writeErasureCoded", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class writeErasureCoded_args(object):
    """
    Attributes:
     - mbMetadata
     - data
    ...
    def __init__(self, mbMetadata=None, data=None,):
        self.mbMetadata = mbMetadata
        self.data = data
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('writeErasureCoded_args')
        if self.mbMetadata is not None:
            oprot.writeFieldBegin('mbMetadata', TType.STRUCT, 1)
            self.mbMetadata.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(writeErasureCoded_args)
writeErasureCoded_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'mbMetadata', [Metadata, None], None, ),  # 1
    (2, TType.STRING, 'data', 'BINARY', None, ),  # 2
)
...
class writeErasureCoded_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('writeErasureCoded_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(writeErasureCoded_result)
writeErasureCoded_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WriteResponse, None], None, ),  # 0
)
