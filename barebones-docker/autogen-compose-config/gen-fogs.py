...
def writeFog(id, ip, port, fogFileName):
    ...
    fogCommand  = "\"source tc_rule.sh && java -Xms80m -Xmx800m -cp edgefs/cli/target/edgefilesystem-0.1-jar-with-dependencies.jar com.dreamlab.edgefs.controlplane.FogServer {} {} 1 1 0.25 0\"".format(ip,str(port))
...
def writeEdge(edgeId,edgeIp,edgePort,fogIp,fogPort,edgeFileName):
    ...
    edgeCommand = "\"source tc_rule.sh && java -Xms40m -Xmx200m -cp edgefs/cli/target/edgefilesystem-0.1-jar-with-dependencies.jar com.dreamlab.edgefs.edge.server.EdgeServer {} {} {} 88 {} {}  /edgefs/data  /edgefs/logs\"".format(edgeId,edgeIp,edgePort,fogIp,fogPort)
